//create constuctor to populate fruity inventor with
...
var fruit0 = new fruitBasket("blueberries", 3.99, "/pint", "basket o'plump and delicious blueberries", "images/blueberries.jpg")
var fruit1 = new fruitBasket("raspberries", 3.99, "/pint", "stain-your-fingers delicious raspberries", "images/raspberries.jpg")
var fruit2 = new fruitBasket("mixed berries", 7.00, "/bushel", "a bushel of nature's candy in all colors", "images/mixed-berries.jpg")
var fruit3 = new fruitBasket("nectarines", 2.99,"/lb", "juicy nectarines perfect for early spring picnics", "images/nectarines.jpg")
var fruit4 = new fruitBasket("petite navel oranges", 2.00, "/2 lbs", "SPECIAL price! easy-to-peel petite navel oranges", "images/oranges.jpg")
var fruit5 = new fruitBasket("red cherries", 5.50 ,"/lb", "sweet plump cherries to stain your fingertips with", "images/cherries.jpg")
var fruit6 = new fruitBasket("plums", 1.15, "/lb", "reminds us of childhood summers", "images/plums.jpg")
var fruit7 = new fruitBasket("cantaloupe", 1.85, " each", "sweet slices o'heaven await!", "images/melon.jpg")
var fruit8 = new fruitBasket("gala apples", 1.85, " /lb", "sweet and snappy crunch!", "images/apples.jpg")
